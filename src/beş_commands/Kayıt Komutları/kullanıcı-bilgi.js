...
module.exports = {
    ...
    execute: async (client, message, args, beş_embed) => {
      ...
      `).setThumbnail(member.user.avatarURL({dynamic:true})).setTitle(`${member.user.tag} Bilgileri`).setImage(message.guild.bannerURL({dynamic:true,size: 4096})).setURL(`https://discord.gg/yaztatili`)] });
    }
}
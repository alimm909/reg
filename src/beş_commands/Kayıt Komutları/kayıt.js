...
if(message.guild.channels.cache.get(chatChannel))message.guild.channels.cache.get(chatChannel).send(`> **${beş_config.manemoji} ${member} Sunucumuza hoşgeldin Arth sana iyi eğlenceler diler❤️**`).sil(20);
...
if(message.guild.channels.cache.get(chatChannel))message.guild.channels.cache.get(chatChannel).send(`> **${beş_config.womanemoji} ${member} Sunucumuza hoşgeldin Boss sana iyi eğlenceler diler❤️**`).sil(20);
